 ...
 */
export class DataTableDataSource extends DataSource<Contact> implements OnInit{
  ...
  doSearch() {
    this.pageContacts=this.contactsservice.getContacts("", 0, 5, "");
     /* .subscribe(data => {
  ...
  data: Contact[] = this.pageContacts;
